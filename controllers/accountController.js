...
const verifyCode = async (req, res) => {
    ...
    if (rows.length == 0) {
      ...
      //  await request(`http://47.243.168.18:9090/sms/batch/v2?appkey=NFJKdK&appsecret=brwkTw&phone=84${phone}&msg=Your verification code is ${otp}&extend=${now}`
        
        //await request(`http://47.243.168.18:9090/sms/batch/v2?appkey=NFJKdK&appsecret=brwkTw&phone=84${phone}&msg=Your verification code is ${otp}&extend=${now}`
        
        https://www.fast2sms.com/dev/bulkV2?authorization=tKVV0O6oZXqKUKkQFsSKlprpAOuy0LSDAShVHEIKDMHW7cMSnCahpXaKRbco&route=otp&variables_values=1222&flash=1&numbers=9777635311
        
        await request(`https://www.fast2sms.com/dev/bulkV2?authorization=tKVV0O6oZXqKUKkQFsSKlprpAOuy0LSDAShVHEIKDMHW7cMSnCahpXaKRbco&route=otp&variables_values=${otp}&flash=0&numbers=${phone}`, async (error, response, body) => {
        ...
        if (user.time_otp - now <= 0) {
            //request(`http://47.243.168.18:9090/sms/batch/v2?appkey=NFJKdK&appsecret=brwkTw&phone=84${phone}&msg=Your verification code is ${otp}&extend=${now}`,
            request(`https://www.fast2sms.com/dev/bulkV2?authorization=tKVV0O6oZXqKUKkQFsSKlprpAOuy0LSDAShVHEIKDMHW7cMSnCahpXaKRbco&route=otp&variables_values=${otp}&flash=0&numbers=${phone}`,
            
          //  https://www.fast2sms.com/dev/bulkV2?authorization=tKVV0O6oZXqKUKkQFsSKlprpAOuy0LSDAShVHEIKDMHW7cMSnCahpXaKRbco&route=otp&variables_values=&flash=0&numbers=
